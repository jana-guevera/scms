...
<script>
    ...
    document.getElementById("nav-friends").classList.add("active-page");
...
<script>
    const fetchData = async (searchQuery) => {
        var url = searchQuery == "" ? getURL("members/get_online_members_with_survey.php") 
                                    : getURL("members/search_online_members_with_survey.php?id=" + memberId + "&search=" + searchQuery);
