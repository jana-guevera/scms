                        ...
                        <div class="td-right">
                            ...
                            <div class="record-dropdown-wrapper" id="dropdown-wrapper-${data}">
                                <div class="record-dropdown">
                                    ...
                                    <a href="member_friends_matcher.php?id=${data}"><i class="fas fa-search"></i>Find Friends</a>
                                    <a href="member_friends.php?id=${data}"><i class="fas fa-user-friends"></i></i>Friends</a>
                                    <a href="member_schedules.php?id=${data}"><i class="fas fa-calendar-alt"></i>Schedules</a>
                                </div>
                            </div>
                        </div>
                    `;
