...
<script>
    document.getElementById("nav-survey_categories").classList.add("active-page");
    document.getElementById("add-item-button").textContent = "Add Category";
    document.getElementById("pageTitle").textContent = "Survey Categories";
    ...
    dataTable = $("#table_id").DataTable({
        "ajax": {
            "url": getURL("survey_categories/read_all.php"),
            "type": "GET",
            "datatype": "json",
            "dataSrc": "records"
        },
...
<script>
    const triggerAddNew = () => {
        document.querySelector('#modalLongTitle').innerHTML = "Add Survey Category";
    ...
    const addRecord = async () => {
        ...
        try{
            var result = await fetch(getURL("survey_categories/create.php"), { 
                method: 'POST',
                headers: {
...
<script>
    const triggerUpdateModal = async(id) => {
        try{
            var result = await fetch(getURL("survey_categories/read_one.php?id=" + id));
            result = await result.json();
    ...
    const updateRecord = async (record) => {
        document.querySelector('#modalLongTitle').innerHTML = "Update Survey Category";
        ...
        document.getElementById('updateRecordBtn').addEventListener('click', async () => {
            ...
            try{
                var result = await fetch(getURL("survey_categories/update.php"), { 
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
...
<script>
    ...
    const deleteRecord = async (id) => {
        showLoaderOnViewPort("Removing survey category...");

        try{
            var result = await fetch(getURL("survey_categories/remove.php?id=" + id));
            result = await result.json();
