...
<script>
    ...
    document.getElementById("pageTitle").textContent = "Member Survey";
    ...
    breadcumbs.innerHTML = `<li><a href="offline_members.php">Offline Members</a></li>
                            <li><a href="member_survey.php?id=${memberId}">Member Survey</a></li>`;
    ...
    const fetchData = async () => {
        ...
        document.getElementById("pageTitle").textContent = "Member Survey - " + member.record.name;
